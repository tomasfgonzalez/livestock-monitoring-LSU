...
/**
 * @brief Set shutdown mode for the sensor. In shutdown mode, registers can still be read and written,
 *        but all analog functions and interrupts are disabled.
 *
 * @param obj Pointer to max30102_t object instance.
 * @param shutdown Enable shutdown mode (1) or normal operation (0).
 */
